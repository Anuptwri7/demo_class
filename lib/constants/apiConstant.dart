class StringConst {
  ...
  // static String branchUrl = 'https://api.demo.ybs.com.np/api/v1/branches';
  /// speed automation
  // static String branchUrl = 'https://api-speed.sooritechnology.com.np/api/v1/branches';
  ...
  static String urlPurchasePendingAppList = '/api/v1/purchase-app/get-orders';
  ...
  static String dispatchList= '/api/v1/dispatch-app/dispatch-list';
  static String dispatchedList= '/api/v1/dispatch-app/dispatch';
  ...
  static String locationShiftingApi = '/api/v1/item-serialization-app/update-pack-location';
  static String bulkLocationShiftingApi = '/api/v1/item-serialization-app/bulk-update-pack-location';
